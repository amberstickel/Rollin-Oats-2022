...
registerBlockType("rollinoats/sectionimage", {
...
function EditComponent(props) {
  ...
  return (
    <>
      ...
      <div className={`ro--section__bg-img ro--section__bg-img--${horizontalPlacement}`} style={customCSS}>
        <div className="ro--section__bg-img-wrapper" style={{transform: scaleProperty}}>
        <InnerBlocks />
        </div>
      </div>
    </>
